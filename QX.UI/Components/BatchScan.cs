...
{
    public partial class BatchScan : Bse_PopForm
    {
        public BatchScan()
        {
            InitializeComponent();
        ...
        void scanBtn_Click(object sender, EventArgs e)
        {
            ...
            string compNo = CompSource[0].PRDC_CompNo;
        ...
        private List<Prod_Components> CompSource
        {
            get;
            set;
        }
        ...
        public void InitData()
        {
            ...
            otherCompGrid = gen.GenerateGrid("CList_BatchRefComp", this.panel2, new Point(0, 0));
        ...
        void comGrid_DoubleClickRow(object sender, DoubleClickRowEventArgs e)
        {
            ...
            {
                Prod_Doc doc = row.ListObject as Prod_Doc;
                CC_File file = CurrentDataSource.FirstOrDefault(o => o.CCF_DCode == doc.PRDQ_Code);
                if (file != null)
                {
        ...
        public void SaveDictionary()
        {
            ...
            if (row != null)
            {
                ...
                foreach (var r in this.otherCompGrid.Rows)
                {
                    ...
                    if (list.FirstOrDefault(o => o.PRDC_CompNo == c.PRDC_CompNo) == null)
                    {
                        list.Add(c);
        ...
        public void SaveGrid()
        {
            ...
            foreach (var row in comGrid.Rows)
            {
                ...
                if (!string.IsNullOrEmpty(doc.PRDQ_Code))
                {
                    ...
                    doc.PRDQ_Bak = SessionConfig.UserName + "," + "批量扫描生成";

                    compInstance.AddOrUpdateCDocForRef(doc, CompSource);
