...
{
    public partial class DocQuery : Bse_Form
    {
        //public DocQuery()
        //{
        //    InitializeComponent();

        //    this.Load += new EventHandler(DocQuery_Load);
        //}
        ...
        //{
        //    var dd = dcInstance.GetDirectoryList();
        //    var root = dd.Where(o => string.IsNullOrEmpty(o.DD_PCode));
        ...
        //        GenereateTree(node, f);
        //    }
        //}

        //public void GenereateTree(TreeNode node, Doc_Directory parent)
        //{
        //    switch (node.Name)
        //    {
        //        case "Prod":
        //            {
        //                var list = dcInstance.GetProdList();

        //                var dlist = dcInstance.GetProdRefCompList();

        //                foreach (var p in list)
        //                {
        //                    TreeNode n = new TreeNode();

        //                    n.Name = p.PRP_ProdCode;
        //                    n.Text = p.PRP_Name;
        //                    node.Nodes.Add(n);

        //                    var temp = dlist.Where(o => o.PRDC_ProdCode == p.PRP_ProdCode).ToList();
        ...
        //                            nc.Name = c.PRDC_CompNo;
        //                            nc.Text = c.PRDC_CompName;
        //                            n.Nodes.Add(nc);
        //                        }
        //                    }
        ...
        //        case "Components":
        //            {
        //                var list = dcInstance.GetCompList();
        //                foreach (var c in list)
        //                {
        //                    TreeNode n = new TreeNode();

        //                    n.Name = c.PRDC_CompNo;
        //                    n.Text = c.PRDC_CompName;
        //                    node.Nodes.Add(n);
        //                }
        //                break;
        //            }
        ...
        void top_tool_bar_SearchClicked(object sender, EventArgs e)
        {
            ...
            if (obj == null)
            {
                ...
                dt = new BLL.Bll_Comm().ListViewData(string.Format("select * from VRpt_DocQuery where 1=1 {0}", where));
        ...
        public void InitControl()
        {
            ...
            comGrid = gen.GenerateGrid("CList_DocQuery", this.pnlDoc, new Point(0, 0));
            comGrid.DoubleClickRow += new DoubleClickRowEventHandler(comGrid_DoubleClickRow);
            DataTable dt = new BLL.Bll_Comm().ListViewData(string.Format("select * from VRpt_DocQuery where 1>2 "));
            comGrid.DataSource = dt;
        }
